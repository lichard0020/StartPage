...
let userName = prompt("键入你的名字:");
function changeScoreWord() {
    document.getElementById("score").innerHTML = userName + ",Your score is : 0";
}
...
const CANVAS_BACKGROUND_COLOUR = "#6495ED";
...
function main() {
    if (didGameEnd()) {
        document.getElementById('start').innerHTML = ("再来亿次");
        document.getElementById("start").style.display = 'None';
        document.getElementById('score').innerHTML = ('刷新页面再来亿次~ 得分为：' + score);
        document.getElementById("title").innerHTML = ('贪 吃 蛇 - Game Over');
        alert('Game over! 你最后的分数是 : ' + score);
        return;
    }
...
* 随机生成食物坐标
*/
function createFood() {        // 随机生成食物的 x 坐标
